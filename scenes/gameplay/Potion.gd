...
func _ready() -> void: 
	...
	$GoUpTween.interpolate_property(self, "m_verticalVelocity", START_VELOCITY, 0, 3, Tween.TRANS_QUAD, Tween.EASE_OUT)
...
func _on_GoUpTween_tween_completed(_object: Object, _key: NodePath) -> void:
	 $GoDownTween.interpolate_property(self, "m_verticalVelocity", 0, -START_VELOCITY, 3, Tween.TRANS_QUAD, Tween.EASE_IN)
